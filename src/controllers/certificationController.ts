import { parseOwnerList, ownerListSchema } from "../validations/ownerListValidation";
...
export class CertificationController {
  ...
  async getAllCertifications(req: Request, res: Response) {
    ...
    try {
      ...
      const result = await this.certificationService.findAllCertifications(req.params.ownerId || "", language, parseOwnerList(ownerListSchema, req.query));
